...
In addition a Key.json will have to be downloaded for the Google Vision Api to be accessed. For thata new account will have to be cretaed for the Google Vision API.
